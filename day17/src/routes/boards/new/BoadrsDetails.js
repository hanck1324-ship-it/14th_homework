...
import spinningtop from "../../../assets/spinningtop.png";
...
const BoardsDetail = () => {
    ...
    <div className="Css_detail_page_body">
        ...
        <div className="Css_detail_title">살어리 살어리랏다 쳥산(靑山)애 살어리랏다멀위랑 ᄃᆞ래랑 먹고 쳥산(靑山)애 살어리랏다얄리얄리 얄랑셩 얄라리 얄라</div>
       <div className="Css_detail_nav">
            <div className=""></div>
      ...
      <div className="detail-body">
        <div className="detail-frame">
          ...
          <div className="detail-metadata-icon-container">
            <img src={linkImage} alt="링크아이콘" />
            <img src={locationImage} alt="위치아이콘" />
          </div>
